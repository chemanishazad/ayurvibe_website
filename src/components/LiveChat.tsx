...
const LiveChat = () => {
  ...
  const botResponses = {
    ...
    'location': 'We\'re located at 12/597, Main Road, Nethaji Nagar Main Rd, Nookampalayam, Perumbakkam, Chennai, Tamil Nadu 600131 — easy to reach from OMR, Sholinganallur, and nearby areas. We\'re open 10:00 AM - 8:00 PM every day.',
