  ...
  useEffect(() => {
    ...
    api.patients
      ...
      .then((p) => {
        ...
        const pin = String(p.pincode ?? '').replace(/\D/g, '');
        if (pin.length === 6) lastFetchedPincode.current = pin;
        setFormData({
          countryCode,
          mobile,
          name: p.name ?? '',
    ...
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <Card className="flex-1 min-h-0 overflow-auto">
        <CardHeader>
          ...
          <CardDescription>Edit beneficiary information. Press Enter in Address field for new line.</CardDescription>
        </CardHeader>
